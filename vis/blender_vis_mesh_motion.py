...
def run_blender_rendering_and_save2video(obj_folder_path, out_folder_path, out_vid_path, \
    scene_blend_path="/home/litianyi/workspace/EgoMotion/vis/blender_utils/for_demo.blend", \
    mat_color="blue"):
    ...
    subprocess.call("/home/litianyi/software/blender-3.5.1-linux-x64/blender \
    -P /home/litianyi/workspace/EgoMotion/vis/blender_vis_human_utils.py \
...
def run_blender_rendering_and_save2video_cmp(obj_folder_path, gt_obj_folder_path, out_folder_path, out_vid_path, \
    ...
    -P /home/litianyi/workspace/EgoMotion/vis/blender_vis_cmp_human_utils.py \
...
def run_blender_rendering_and_save2video_head_pose(npy_path, out_folder_path, out_vid_path, vis_head_only=False, \
    ...
    if vis_head_only:
        subprocess.call("/viscam/u/jiamanli/blender-3.2.0-linux-x64/blender \
        -P /home/litianyi/workspace/EgoMotion/vis/blender_vis_human_and_headpose_utils.py \
